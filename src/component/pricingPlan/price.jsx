  ...
  return (
    <>
      ...
      <div className="priceplanHeader">
        <h1>
          <span className="darkBlue">IdeaCollab </span>
          your way.
        </h1>
        <h2>
          Trusted by millions, IdeaCollab powers teams all around the world. Explore
      ...
      <div className="frquently">
        ...
        <div className="quest">
          <ul>
            <li>
              <div>
                <span>+ </span>Does IdeaCollab offer a premium free trails?
              </div>
            </li>
            <li>
              <div>
            ...
            {/* <li>
              <div>
                <span>+ </span> How do i can my IdeaCollab standard and permium free
                trail?
              </div>
            </li> */}
            <li>
