      ...
      <nav className={`homeNavbar ${isMenuOpen ? "open" : ""}`}>
        ...
        <div className={`navItems ${isMenuOpen ? "open" : ""}`}>
          <Slider title="Solutions">
            <h1>
              Take a page out of these pre-built IdeaCollab playbooks{" "}
              <span> designed for all teams</span>
            </h1>
            <div className="solutionContainer">
              <div>
                <h3>IdeaCollab For Marketing Teams</h3>
                <img src={solution1Img}></img>
                <p>
                  Whether launching a new product, campaign, or creating
                  content, experience how IdeaCollab helps marketing teams around
                  the world organize, plan, and get more done.
                </p>
              </div>
              <div>
                <h3>IdeaCollab For Design Teams</h3>
                <img src={solution2Img}></img>
                <p>
                  From creative brainstorms to the final touches, discover how
                  IdeaCollab helps your design teams deliver with style.
                </p>
              </div>
              <div>
                <h3>IdeaCollab For Remote Teams</h3>
                <img src={solution3Img}></img>
                <p>
                  From team bonding and brainstorming to meetings and project
                  planning, discover how IdeaCollab keeps remote teams connected, no
          ...
          <Slider title="Plans">
            <h1>
              Whether you’re a team of 2 or 2,000, IdeaCollab flexible pricing model
          ...
          <Slider title="Resources">
            ...
            <div className="resourceContainer">
              <div className="resourceButtons">
                ...
                <button onClick={() => navigate("/dashboard")}>
                  IdeaCollab Developer
                </button>
                <button onClick={() => navigate("/dashboard")}>
                  IdeaCollab Customer Stories
                </button>
              </div>
